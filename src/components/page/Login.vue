...
/* General Demo Style */
body{
    font-family: PingFang Light, Georgia, serif;
    font-weight: 400;
    font-size: 15px;
    color: #1d3c41;
    overflow-y: scroll;
...
.container > header h1{
    /*font-family: 'PingFang Light', 'Arial Narrow', Arial, sans-serif;*/
    font-size: 35px;
    line-height: 35px;
    position: relative;
    font-weight: 400;
...
@font-face {
    ...
    src: url('../../assets/fonts/fontomas-webfont.eot?#iefix') format('embedded-opentype'),
         url('../../assets/fonts/fontomas-webfont.woff') format('woff'),
         url('../../assets/fonts/fontomas-webfont.ttf') format('truetype'),
         url('../../assets/fonts/fontomas-webfont.svg#FontomasCustomRegular') format('svg');
    font-weight: normal;
    font-style: normal;
}
