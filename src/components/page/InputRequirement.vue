        ...
        <div class="form-box">
            <el-form ref="form" :model="form" label-width="80px">
                ...
                <el-form-item label="测试输入">
                    <h4>测试</h4><a href="javascript:void(0)" @click="add">新增</a>
                       <p v-for="(test,index) in form.tests">
                           <el-input v-model="test.text" type="text" name="tests[]"></el-input><a href="javascript:void(0)" @click="remove(index)">刪除</a>
                       </p>
                </el-form-item>
